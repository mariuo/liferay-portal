...
public class ViewTeamsDisplayContext extends BaseSectionDisplayContext {
	...
	protected String getCMSSectionFilterString() {
		...
		try {
			id = _objectDefinitionService.getObjectDefinitionByExternalReferenceCode("L_CMS_TEAMS", themeDisplay.getCompanyId()).getObjectDefinitionId();
		}
		...
		ObjectDefinition objectDefinition =
			ObjectDefinitionLocalServiceUtil.
				fetchObjectDefinitionByExternalReferenceCode(
					"L_CMS_TEAMS", themeDisplay.getCompanyId());
