...
public class ObjectValidationRuleLocalServiceTest {
	...
	public void testAddCompositeKeyObjectValidationRuleWithSystemObjectFields()
		...
		// A nonmetadata system object field of a modifiable system object
		// definition can be added to a unique composite key
		...
		// definition cannot be added to a unique composite key
		...
		// A nonmetadata system object field of an unmodifiable system object
		// definition cannot be added to a unique composite key
		...
		ObjectDefinition unmodifiableSystemObjectDefinition =
			ObjectDefinitionTestUtil.addUnmodifiableSystemObjectDefinition(
				...
				Arrays.asList(
					_createTextObjectField(objectFieldName1),
					_createTextObjectField(objectFieldName2)));

		try {
			ObjectField unmodifiableSystemObjectField1 =
				_objectFieldLocalService.fetchObjectField(
					unmodifiableSystemObjectDefinition.getObjectDefinitionId(),
					objectFieldName1);
			ObjectField unmodifiableSystemObjectField2 =
				_objectFieldLocalService.fetchObjectField(
					unmodifiableSystemObjectDefinition.getObjectDefinitionId(),
					objectFieldName2);
			...
			AssertUtils.assertFailure(
				...
				String.format(
					"The value \"%s\" of the object validation rule setting " +
						"\"%s\" is invalid",
					unmodifiableSystemObjectField1.getObjectFieldId(),
					ObjectValidationRuleSettingConstants.
						NAME_COMPOSITE_KEY_OBJECT_FIELD_ID),
				() -> _addObjectValidationRule(
					StringPool.BLANK,
					...
					StringPool.BLANK, false,
					_createCompositeKeyObjectValidationRuleSettings(
						unmodifiableSystemObjectField1,
						unmodifiableSystemObjectField2)));
		}
		finally {
			_objectDefinitionLocalService.deleteObjectDefinition(
